		...
		<div class="dengji_table">
			...
			<div class="basic_table">
				<div class="clospan">
					...
					<p>
						<input name="age" id="age" type="number" min="18" max="99" value="20" class="easyui-validatebox" data-options="required:true" placeholder="年龄不得小于18" />
					</p>
				</div>
			</div>
			<div class="basic_table">
			...
			<div class="clospan_func">
				<div class="btns">
					<a href="javascript:void(0);" id="doSubmit" class="blank_btn">保存</a> <a href="javascript:void(0);" onclick="doCancel();" class="blank_btn">返回</a>
				</div>
			</div>
		</div>
	</form>
